defmodule RocinanteWeb.EventControllerTest do
  use RocinanteWeb.ConnCase

  alias Rocinante.Events

  @create_attrs %{description: "some description", ends_at: ~N[2010-04-17 14:00:00], starts_at: ~N[2010-04-17 14:00:00], title: "some title"}
